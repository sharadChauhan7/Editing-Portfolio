...
function Landing() {
  return (
    <div className="max-h-screen w-full bg-[#F8F8F8] text-[#222222] flex flex-col items-center">
      {/* Top Nav */}
      ...
      <div className="flex-1 flex flex-col items-start px-6 md:px-16">
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          {/* Subtitle */}
          <p className="text-[#7B7B7B] text-lg text-center md:text-left mb-8">
            — The editing wizard
          </p>
          ...
          <div className="flex gap-2 flex-row sm:space-x-10 space-y-4 sm:space-y-0 mb-10 text-center sm:text-left">
            <div>
              ...
              <p className="text-[#7B7B7B] text-sm">Instagram Follower</p>
            </div>
            <div>
              <h3 className="text-4xl sm:text-5xl lg:text-6xl font-extralight">
                {landingPageData.views}k+
              </h3>
              <p className="text-[#7B7B7B] text-sm">Video views</p>
            </div>
          </div>

          {/* Scroll Down */}
          <div className="mt-12 text-base text-[#7B7B7B]">
            Scroll down ↓
          </div>
        </div>
      </div>
