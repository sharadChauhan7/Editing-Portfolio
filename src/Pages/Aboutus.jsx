...
function Aboutus() {
  return (
    <section id="about" className="bg-[#F5F5F5] px-4 sm:px-6 md:px-10 lg:px-16 py-20 text-[#222]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-2/5 space-y-6 text-center lg:text-left">
          ...
          <p className="text-[#555] text-sm sm:text-base md:text-lg px-2 lg:px-0">
        ...
        <div className="w-full lg:w-3/5 grid grid-cols-1 sm:grid-cols-2 max-sm:gap-15 gap-6">
          {/* Stat Card */}
          <div className="bg-white rounded-2xl shadow-sm p-5 flex flex-col items-start text-left space-y-4">
            <img
              src={World}
              alt="Client"
            ...
            <p className="text-[#7B7B7B] text-sm">Video edited</p>
